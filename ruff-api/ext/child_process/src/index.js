...
function ChildProcess() {
    ...
    this._onExit = function(code, signalCode) {
        ...
        if (self.stdin && self.stdin._handle) {
            uv.close(self.stdin._handle);
            self.stdin._handle = null;
        }
        if (self.stdout && self.stdout._handle) {
            uv.close(self.stdout._handle);
            self.stdout._handle = null;
        }
        if (self.stderr && self.stderr._handle) {
            uv.close(self.stderr._handle);
            self.stderr._handle = null;
        }
        maybeClose(self);

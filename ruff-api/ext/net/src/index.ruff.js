...
Socket.prototype._write = function (data, encoding, cb) {
    ...
    try {
        var destroyedState = this.destroyed;
        this._handle.write(data, function (error) {
            afterWrite(that, cb, error, destroyedState);
        });
    } catch (error) {
...
function afterWrite(socket, callback, error, destroyedState) {

...
TLSSocket.prototype._tlsWrite = function (data) {
    mbedtls.write(this._tlsHandle, Buffer.from(data)._ruffBuffer);
};
...
TLSSocket.prototype._sendCallback = function (data) {
    Socket.prototype._write.call(this, Buffer.from(data), undefined, noOp);
};
...
TLSSocket.prototype._receiveCallback = function (length) {
    ...
    return Buffer.from(resultData)._ruffBuffer;
};
